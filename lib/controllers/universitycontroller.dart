...
class UniversityController extends GetxController {
  ...
  Future<void> fetchUniversities() async {
    try {
      ...
      final response = await _supabase.from('universities').select('''*,campuses(*,accommodations(*)),faculties(*,departments(*,programs(*))),contacts(*)''').order('name', ascending: true); // Fetch data with proper typing
